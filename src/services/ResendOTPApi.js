...
/**
 * Resend OTP to the validated mobile number
 ...
 */
export async function resendOTP(msisdn, { channelId = 'C04', simType = 'PREPAID', sessionId } = {}) {
  const path = `/${API_CONFIG.ENDPOINTS.RESEND_OTP}`;
