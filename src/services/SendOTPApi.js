...
/**
 * Send OTP to the validated mobile number
 ...
 */
export async function sendOTP(msisdn, { channelId = 'C04', simType = 'PREPAID', sessionId } = {}) {
  const path = `/${API_CONFIG.ENDPOINTS.SEND_OTP}`;
